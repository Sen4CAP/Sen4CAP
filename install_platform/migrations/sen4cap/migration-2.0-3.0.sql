...
-- ---------------------------- END TODO --------------------------------------
            ...
            _statement := $str$
                DROP FUNCTION sp_insert_product(smallint, smallint, integer, smallint, integer, character varying, timestamp with time zone, character varying, character varying, geography, integer, json, smallint, integer)
