...
INSERT INTO config(key, site_id, value, last_updated) VALUES ('general.orchestrator.docker_image', NULL, 'sen2agri/processors:2.0.0', '2021-01-14 12:11:21.800537+00');
...
INSERT INTO config(key, site_id, value, last_updated) VALUES ('executor.module.path.no-operation-step', NULL, '/usr/bin/true', '2016-01-12 14:56:57.501918+02');
...
insert into config(key, site_id, value, last_updated) VALUES ('processor.l2a.processors_image', NULL, 'sen4x/l2a-processors:0.1.2', '2021-04-19 16:30:00.0');
...
insert into config(key, site_id, value, last_updated) VALUES ('processor.l2a.gdal_image', NULL, 'osgeo/gdal:ubuntu-full-3.3.1', '2021-04-19 16:30:00.0');
