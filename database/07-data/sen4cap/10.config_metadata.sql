...
INSERT INTO config_metadata VALUES ('processor.l2s1.parallelism', 'Tiles to classify in parallel', 'int', false, 15) ;
INSERT INTO config_metadata VALUES ('processor.l2s1.path', 'The path where the S1 L2 products will be created', 'string', false, 15);
INSERT INTO config_metadata VALUES ('processor.l2s1.temporal.offset', 'S1 pre-processor offset', 'int', false, 15) ;
...
-- -----------------------------------------------------------
INSERT INTO config_metadata VALUES ('archiver.max_age.s4c_l4a', 'S4C L4A Product Max Age (days)', 'int', false, 7);
INSERT INTO config_metadata VALUES ('executor.processor.s4c_l4a.keep_job_folders', 'Keep S4C L4A temporary product files for the orchestrator jobs', 'int', false, 8);
INSERT INTO config_metadata VALUES ('executor.processor.s4c_l4a.slurm_qos', 'Slurm QOS for S4C L4A processor', 'string', true, 8);
INSERT INTO config_metadata VALUES ('general.scratch-path.s4c_l4a', 'Path for  S4C L4A temporary files', 'string', false, 1);
...
-- -----------------------------------------------------------
INSERT INTO config_metadata VALUES ('archiver.max_age.s4c_l4b', 'S4C L4B Product Max Age (days)', 'int', false, 7);
INSERT INTO config_metadata VALUES ('executor.processor.s4c_l4b.keep_job_folders', 'Keep S4C L4B temporary product files for the orchestrator jobs', 'int', false, 8);
INSERT INTO config_metadata VALUES ('executor.processor.s4c_l4b.slurm_qos', 'Slurm QOS for S4C L4B processor', 'string', true, 8);
INSERT INTO config_metadata VALUES ('general.scratch-path.s4c_l4b', 'Path for S4C L4B temporary files', 'string', false, 1);
INSERT INTO config_metadata VALUES ('processor.s4c_l4b.default_config_path', 'The default configuration files for all L4B processors', 'file', FALSE, 19);
...
-- -----------------------------------------------------------
INSERT INTO config_metadata VALUES ('archiver.max_age.s4c_l4c', 'S4C L4C Product Max Age (days)', 'int', false, 7);
INSERT INTO config_metadata VALUES ('executor.processor.s4c_l4c.keep_job_folders', 'Keep S4C L4C temporary product files for the orchestrator jobs', 'int', false, 8);
INSERT INTO config_metadata VALUES ('executor.processor.s4c_l4c.slurm_qos', 'Slurm QOS for S4C L4C processor', 'string', true, 8);
INSERT INTO config_metadata VALUES ('general.scratch-path.s4c_l4c', 'Path for S4C L4C temporary files', 'string', false, 1);
INSERT INTO config_metadata VALUES ('processor.s4c_l4c.default_config_path', 'The default configuration files for all L4C processors', 'file', FALSE, 20);
...
INSERT INTO config_metadata VALUES ('processor.s4c_l4c.sched_prds_hist_file', 'File where the list of the scheduled L4Cs is kept', 'string', true, 20);
