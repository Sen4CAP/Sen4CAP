...
(id, name, short_name, label)
VALUES
(9, 'S4C L4A Crop Type','s4c_l4a', 'Sen4CAP L4A &mdash; Crop Type');

INSERT INTO processor
(id, name, short_name, label)
VALUES
(10, 'S4C L4B Grassland Mowing','s4c_l4b', 'Sen4CAP L4B &mdash; Grassland Mowing');

INSERT INTO processor
(id, name, short_name, label)
VALUES
(11, 'S4C L4C Agricultural Practices','s4c_l4c', 'Sen4CAP L4C &mdash; Agricultural Practices');
