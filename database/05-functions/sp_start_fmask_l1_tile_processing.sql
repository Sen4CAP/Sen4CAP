CREATE OR REPLACE FUNCTION public.sp_start_fmask_l1_tile_processing(_node_id text)
 RETURNS TABLE(site_id integer, satellite_id smallint, downloader_history_id integer, path text, orbit_id integer, tile_id text)
 LANGUAGE plpgsql
AS $function$
