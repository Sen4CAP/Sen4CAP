...
sen2agri-orchestrator.depends = sen2agri-common sen2agri-persistence sen2agri-http-server-common
sen2agri-http-listener.depends = sen2agri-common sen2agri-persistence QtWebApp
sen2agri-http-server-common.depends = sen2agri-common sen2agri-persistence QtWebApp
sen2agri-monitor-agent.depends = sen2agri-common
sen2agri-scheduler.depends = sen2agri-common sen2agri-persistence
sen2agri-processor-wrapper.depends = sen2agri-common
