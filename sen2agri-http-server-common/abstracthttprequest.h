...
public:
    ...
    /**
      ...
      one is returned.
    */
    virtual QByteArray getHeader(const QByteArray& name) const = 0;

    /**
      Get the values of a HTTP request header.
      @param name Name of the header, not case-senitive.
    */
    virtual QList<QByteArray> getHeaders(const QByteArray& name) const = 0;

    /**
     * Get all HTTP request headers. Note that the header names
     * are returned in lower-case.
     */
    virtual QMultiMap<QByteArray,QByteArray> getHeaderMap() const = 0;
    ...
    /**
      ...
      one is returned.
    */
    virtual QByteArray getParameter(const QByteArray& name) const = 0;

    /**
      Get the values of a HTTP request parameter.
      @param name Name of the parameter, case-sensitive.
    */
    virtual QList<QByteArray> getParameters(const QByteArray& name) const = 0;

    /** Get all HTTP request parameters. */
    virtual QMultiMap<QByteArray,QByteArray> getParameterMap() const = 0;
    ...
    */
    virtual QTemporaryFile* getUploadedFile(const QByteArray fieldName) const  = 0;
