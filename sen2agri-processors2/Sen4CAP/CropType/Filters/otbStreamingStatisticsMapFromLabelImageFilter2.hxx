...
PersistentStreamingStatisticsMapFromLabelImageFilter2<TInputVectorImage, TLabelImage>
...
template<class TInputVectorImage, class TLabelImage>
const typename PersistentStreamingStatisticsMapFromLabelImageFilter2<TInputVectorImage, TLabelImage>::LabelImageType*
PersistentStreamingStatisticsMapFromLabelImageFilter2<TInputVectorImage, TLabelImage>
::GetInputLabelImage()
{
...
template<class TInputVectorImage, class TLabelImage>
typename PersistentStreamingStatisticsMapFromLabelImageFilter2<TInputVectorImage, TLabelImage>::LabelPopulationMapType
PersistentStreamingStatisticsMapFromLabelImageFilter2<TInputVectorImage, TLabelImage>
...
template<class TInputVectorImage, class TLabelImage>
typename PersistentStreamingStatisticsMapFromLabelImageFilter2<TInputVectorImage, TLabelImage>::PixelCountMapType
PersistentStreamingStatisticsMapFromLabelImageFilter2<TInputVectorImage, TLabelImage>
    ...
    for (unsigned int band = 0 ; band < mean.GetSize() ; band++)
      ...
      if (count > 0)
        ...
        if (count > 1)
          ...
          {
          const double variance = sqSum[band] - (sum[band] * mean[band]);
          std[band] = std::sqrt(variance);
          }
        }
        else
