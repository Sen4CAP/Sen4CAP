...
public:
  ...
  // Constructor (default)
  StatisticsAccumulator2() : m_Count(), m_NoDataValue(), m_UseNoDataValue() {}

  // Constructor (initialize the accumulator with the given pixel)
  StatisticsAccumulator2(RealValueType noDataValue,
                        bool useNoDataValue,
  ...
  void Update(const StatisticsAccumulator2 & other)
  {
...
/** \class PersistentStreamingStatisticsMapFromLabelImageFilter2
 ...
 *
 *
 * \sa StreamingStatisticsMapFromLabelImageFilter2
 * \ingroup Streamed
...
class ITK_EXPORT PersistentStreamingStatisticsMapFromLabelImageFilter2 :
...
public:
  ...
  itkTypeMacro(PersistentStreamingStatisticsMapFromLabelImageFilter2, PersistentImageFilter);
  ...
  typedef StatisticsAccumulator2<RealVectorPixelType>                    AccumulatorType;
...
protected:
  ...
  ~PersistentStreamingStatisticsMapFromLabelImageFilter2() override {}
  void PrintSelf(std::ostream& os, itk::Indent indent) const override;

  void ThreadedGenerateData(const RegionType& outputRegionForThread, itk::ThreadIdType threadId ) override;

private:
  PersistentStreamingStatisticsMapFromLabelImageFilter2(const Self &) = delete;
...
}; // end of class PersistentStreamingStatisticsMapFromLabelImageFilter2


/*===========================================================================*/

/** \class StreamingStatisticsMapFromLabelImageFilter2
 * \brief Computes mean radiometric value for each label of a label image, based on a support VectorImage
 *
 * Currently the class only computes the mean value.
 *
 * This class streams the whole input image through the PersistentStreamingStatisticsMapFromLabelImageFilter2.
 *
 ...
 * \code
 * typedef otb::StreamingStatisticsMapFromLabelImageFilter2<ImageType> StatisticsType;
...
public:
  ...
  typedef PersistentFilterStreamingDecorator
      <PersistentStreamingStatisticsMapFromLabelImageFilter2<TInputVectorImage, TLabelImage> > Superclass;
  typedef itk::SmartPointer<Self>       Pointer;
  typedef itk::SmartPointer<const Self> ConstPointer;
  ...
  itkTypeMacro(StreamingStatisticsMapFromLabelImageFilter2, PersistentFilterStreamingDecorator);
  ...
  /** Configure whether pixels with a no data value in one of their bands are ignored */
  void SetUseNoDataValue(bool useNoDataValue)
  {
      this->GetFilter()->SetUseNoDataValue(useNoDataValue);
  }

  /** Return whether pixels with a no data value in one of their bands are ignored */
...
protected:
  ...
  /** Destructor */
  ~StreamingStatisticsMapFromLabelImageFilter2() override {}

private:
  StreamingStatisticsMapFromLabelImageFilter2(const Self &) = delete;
  void operator =(const Self&) = delete;
};
