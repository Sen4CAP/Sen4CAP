...
#ifndef otbMeanCompositeFunctor_h
#define otbMeanCompositeFunctor_h
...
class MeanCompositeFunctor : public CompositeFunctor<TInput, TOutput, TInput2>
{
public:
  MeanCompositeFunctor()
  {
  }
