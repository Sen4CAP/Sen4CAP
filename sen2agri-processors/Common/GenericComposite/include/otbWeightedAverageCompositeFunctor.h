...
#ifndef otbWeightedAverageCompositeFunctor_h
#define otbWeightedAverageCompositeFunctor_h
...
{
/**
 * \class WeightedAverageCompositeFunctor
 * \brief
 *
 *
...
class WeightedAverageCompositeFunctor : public CompositeFunctor<TInput, TOutput, TInput2>
{
public:
  WeightedAverageCompositeFunctor()
  {
  }
