...
#ifndef otbCountValidPixelsOnlyFunctor_h
#define otbCountValidPixelsOnlyFunctor_h
...
class CountValidPixelsOnlyFunctor : public CompositeFunctor<TInput, TOutput, TInput2>
{
public:
  CountValidPixelsOnlyFunctor()
  {
  }
