...
#ifndef otbMaxCompositeFunctor_h
#define otbMaxCompositeFunctor_h
...
class MaxCompositeFunctor : public CompositeFunctor<TInput, TOutput, TInput2>
{
public:
  MaxCompositeFunctor()
  {
