...
public:
  ...
  typedef std::vector<int>                                              IntervalLimitsType;
  ...
  /** Sets the array for the intervals. These are considered non overlapping intervals and
   * are provided as an array of values */
  void SetIntervalsLimits(const IntervalLimitsType &intervalsLimits);
...
private:
  ...
  IntervalLimitsType                     m_IntervalsLimits;
...
public:
  ...
  typedef typename Superclass::FilterType::IntervalLimitsType        IntervalLimitsType;
  ...
  void SetIntervalsLimits(const IntervalLimitsType &intervalsLimits)
  {
      this->GetFilter()->SetIntervalsLimits(intervalsLimits);
  }
